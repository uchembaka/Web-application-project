    ...
    <div class="admin_main d-flex flex-column p-3 container">
      <div class="mod_donation">
        ...
        <?php require ("../config/connect.php");
            ...
            $q = "SELECT * FROM blog ORDER BY ID DESC LIMIT $offset, $total_records_per_page";
            $result = mysqli_query($connection, $q);


            $msg='';
			//don_rec is an array that stores all selected records and foreach is used to delete all the records in the don_rec array
